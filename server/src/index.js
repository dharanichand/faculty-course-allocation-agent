...
app.get('/api/health',(req,res)=>res.json({ok:true,service:'faculty-course-allocation-agent',agent:process.env.OPENAI_API_KEY?'configured':'local-tools-only',database:mongoose.connection.readyState===1?'connected':'local-memory'}));
