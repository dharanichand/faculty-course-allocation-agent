...
app.use('/api/auth',authRoutes);app.use('/api/agent',agentRoutes);app.use('/api/allocations',allocationRoutes);app.use('/api/data',dataRoutes);app.use('/api/email',emailRoutes);
