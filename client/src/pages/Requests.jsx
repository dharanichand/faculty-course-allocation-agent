...
export default function Requests(){
 ...
 const removeRequest=async(id)=>{if(!confirm('Delete this request? This removes it completely, everywhere - it will not show up as rejected.'))return;try{await apiRequest({method:'DELETE',url:`/data/requests/${id}`});setRows(v=>v.filter(x=>x._id!==id))}catch(e){setError(e?.response?.data?.message||'Could not delete request')}};
