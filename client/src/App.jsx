...
function App(){
 ...
 const HEADER_H='var(--app-header-height)';
 ...
 return <div className="h-screen overflow-hidden bg-transparent text-slate-700">
  ...
  <header className="app-header fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm" style={{height:HEADER_H}}>
   ...
   <nav className="h-28 sm:h-14 grid grid-cols-4 sm:grid-cols-10 items-center gap-1 px-2 sm:px-4 border-t border-slate-100 max-w-[1800px] mx-auto overflow-hidden">
